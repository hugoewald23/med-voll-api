...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var proximaSegundaAs10 = LocalDate.now()
                ...
                .atTime(10,0);
        var medico = cadastrarMedico("Medico", "medico@voll.med", "876908", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Paciente", "paciente@voll.med", "673.429.730-68");
